...
import edu.kis.powp.jobs2d.events.SelectTriangleListener;
...
public class TestJobs2dPatterns {
	...
	private static void setupPresetTests(Application application) {
		...
		SelectTestFigureOptionListener selectTestFigureOptionListener2 = new SelectTestFigureOptionListener(
				DriverFeature.getDriverManager());
		selectTestFigureOptionListener2.selectAlternativeAction();

		SelectRectangleListener rectangleListener = new SelectRectangleListener(
				DriverFeature.getDriverManager());
		SelectTriangleListener triangleListener = new SelectTriangleListener(
				DriverFeature.getDriverManager());
	...
	private static void setupDrivers(Application application) {
		...
		DrawerAdapter dottedLineDriver = new DrawerAdapter();
		dottedLineDriver.setLineType(LineType.DottedLine);
		DriverFeature.addDriver("Dotted Line Simulator", dottedLineDriver);

		DrawerAdapter specialLineDriver = new DrawerAdapter();
		specialLineDriver.setLineType(LineType.SpecialLine);
